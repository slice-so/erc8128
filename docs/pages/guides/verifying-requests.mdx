...
Setting `requiredComponents` **replaces** this default check. The verifier only requires the specified components to appear in the signature, which is how you opt into accepting class-bound signatures:
