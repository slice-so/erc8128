...
import { verifySmartAccount } from './smart-account-verifier'
...
| `nonce` | generated | Present means Non-Replayable; `null` deliberately omits it |
| `ttlSeconds` | `60` | Interoperable library default; shorten when practical |
| `label` | `"request"` | Signature label in headers |
