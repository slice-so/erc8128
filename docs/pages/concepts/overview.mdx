...
Implementations may additionally support class-bound signatures for performance optimization. This mode signs only specified components:
- Signatures that work across endpoints
- Reduced signature overhead for high-frequency requests
- Delegation patterns

:::warning
Class-bound is less secure and optional. Request-bound should be the default.
:::
