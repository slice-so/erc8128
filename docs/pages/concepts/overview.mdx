...
"@signature-params": ("@scheme" "@authority" "@method" "@path" "@query" "content-digest" "content-type");created=1618884473;expires=1618884533;nonce="abc123";tag="erc8128";keyid="eip155:1:0x1234...abcd"
```
...
Content-Type: application/json
Signature-Input: request=("@scheme" "@authority" "@method" "@path" "@query" "content-digest" "content-type");created=1618884473;expires=1618884533;nonce="abc123";tag="erc8128";keyid="eip155:1:0x1234...abcd"
Signature: request=:MEUCIQDXtPCJ5...base64...:
Content-Digest: sha-256=:X48E9qOokqqrvdts8nOJRJN3OWDUoyWxBf7kbu9DBPE=:
...
- `eip155:8453:0x1234...abcd` — Base
- `eip155:42161:0x1234...abcd` — Arbitrum
...
- `@scheme` — URL scheme (prevents HTTP/HTTPS substitution)
...
- `@query` — Query string, with `?` representing an empty query
- `content-digest` — Body hash (if body present)
- `content-type` — Media type (if the request carries `Content-Type`)
