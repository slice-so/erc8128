...
2. **Key identification**: `eip8128:<chainId>:<address>` format
...
```
Signature-Input: eth=("@authority" "@method" "@path" "@query" "content-digest");created=1618884473;expires=1618884533;nonce="abc123";keyid="eip8128:1:0xd8da6bf26964af9d7eed9e03e53415d37aa96045"
```

**Required parameters:**
- `created` — Unix timestamp when signature was created
- `expires` — Unix timestamp when signature expires
- `keyid` — Signer identifier in `eip8128:<chainId>:<address>` format
...
**Examples:**
```
eip8128:1:0xd8da6bf26964af9d7eed9e03e53415d37aa96045
eip8128:8453:0x1234567890abcdef1234567890abcdef12345678
eip8128:42161:0xABCDEF1234567890ABCDEF1234567890ABCDEF12
```
...
"content-digest": sha-256=:X48E9qOokqqrvdts8nOJRJN3OWDUoyWxBf7kbu9DBPE=:
"@signature-params": ("@authority" "@method" "@path" "@query" "content-digest");created=1618884473;expires=1618884533;nonce="abc123";keyid="eip8128:1:0xd8da6bf26964af9d7eed9e03e53415d37aa96045"
```
