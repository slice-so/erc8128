...
type VerifyPolicy = {
   ...
   * When set, accepts class-bound signatures covering at least 
   * these components (as an ordered subsequence), in addition to 
   * request-bound ones. Can include custom headers (e.g., 'x-idempotency-key').
   */
